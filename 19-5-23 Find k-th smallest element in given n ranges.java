...
//   Given another integer q denoting the number of queries. The task is to return the kth smallest element for 
//     each query (assume k>1) after combining all the ranges.
